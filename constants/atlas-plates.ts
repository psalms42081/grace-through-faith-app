...
export const ATLAS_PLATES: Record<string, AtlasPlate> = {
  all: {
    ...
    aspectRatio: 530 / 702,
    hotspots: [
      { id: "all-jerusalem", targetType: "location", targetId: "jerusalem", x: 0.58, y: 0.61, label: "Jerusalem" },
      { id: "all-bethlehem", targetType: "location", targetId: "bethlehem", x: 0.54, y: 0.63, label: "Bethlehem" },
      { id: "all-jericho", targetType: "location", targetId: "jericho", x: 0.66, y: 0.56 },
      { id: "all-nazareth", targetType: "location", targetId: "nazareth", x: 0.50, y: 0.17, label: "Nazareth" },
      { id: "all-sea-of-galilee", targetType: "location", targetId: "sea-of-galilee", x: 0.58, y: 0.12 },
      { id: "all-capernaum", targetType: "location", targetId: "capernaum", x: 0.56, y: 0.10 },
      { id: "all-jordan-river", targetType: "location", targetId: "jordan-river", x: 0.64, y: 0.40 },
      { id: "all-hebron", targetType: "location", targetId: "hebron", x: 0.48, y: 0.69 },
      { id: "all-damascus", targetType: "location", targetId: "damascus", x: 0.85, y: 0.08, radius: 1.5 },
    ],
  },
  patriarchs: {
    id: "patriarchs",
