/**
 * Approved Catalog Seed — the 8 reviewed human-authored plans that complete
 * the 21-title allowlist but are NOT covered by the base/SDA/more scripts.
 *
 * This module is intentionally importable (no process.exit, no shared-pool
 * ownership). The coordinator imports it; the legacy server/seed-plans.ts
 * executable is left untouched and out of the startup path.
 *
 * Titles:
 *   A Life of Prayer · Wisdom for Life · God's Unfailing Love · Living in Hope
 *   Strength in Weakness · Finding Peace · Grace Upon Grace · The Sermon on the Mount
 */
...
interface ApprovedPlanData {
  ...
  days: ApprovedDayData[];
}

// Exactly the 8 approved titles absent from base/SDA/more sources.
// Data transcribed verbatim from server/seed-plans.ts (the editorial-reviewed
// definitions). The duplicate titles that seed-plans.ts also defines
// (Foundations of Faith, Psalms of Comfort, etc.) are intentionally omitted
// here — they are already handled by the base/more seed sources.
const APPROVED_PLANS: ApprovedPlanData[] = [
  {
    title: "A Life of Prayer",
    description:
      "Learn to deepen your prayer life through Scripture's greatest examples and teachings on communion with God.",
    totalDays: 7,
    theme: "prayer",
    category: "foundations",
  ...
  },
  {
    ...
    description:
      "Discover the practical wisdom of Scripture for navigating relationships, decisions, and daily challenges.",
    totalDays: 7,
    theme: "wisdom",
    category: "foundations",
    difficultyLevel: "beginner",
  ...
  },
  {
    ...
    description:
      "Experience the depth, width, and height of God's love through the most powerful passages in Scripture.",
    totalDays: 7,
    theme: "love",
    category: "foundations",
    difficultyLevel: "beginner",
  ...
  },
  {
    ...
    description:
      "Find renewed hope in God's promises — even in the darkest seasons, His light breaks through.",
    totalDays: 5,
    theme: "hope",
    category: "foundations",
    difficultyLevel: "beginner",
  ...
  },
  {
    ...
    description:
      "Discover how God's power is made perfect in weakness — finding supernatural strength for every challenge.",
    totalDays: 5,
  ...
  },
  {
    title: "Finding Peace",
    description:
      "In a world of anxiety and noise, discover the peace that surpasses all understanding.",
    totalDays: 5,
    theme: "peace,comfort",
    category: "foundations",
    difficultyLevel: "beginner",
  ...
  },
  {
    ...
    description:
      "Explore the richness of God's grace — unmerited, transforming, and overflowing for every sinner saved.",
    totalDays: 5,
    theme: "grace,faith",
    category: "foundations",
    difficultyLevel: "beginner",
  ...
  },
  {
    ...
    description:
      "Jesus' most famous teaching — a radical vision for kingdom living that still challenges and inspires today.",
    totalDays: 7,
    theme: "wisdom,faith",
    category: "foundations",
    difficultyLevel: "intermediate",
...
/**
 * Seed the 8 approved plans that complete the 21-title allowlist.
 * Importable, data-only, no process.exit, no pool ownership.
 * Idempotent: inserts plans that are missing and repairs missing days
 * for plans that already exist.
 */
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export async function seedApprovedCatalog(db: NodePgDatabase<any>): Promise<void> {
  ...
  for (const plan of APPROVED_PLANS) {
    ...
    // Partial repair: insert only missing days.
