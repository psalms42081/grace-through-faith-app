...
const portraitSource = require("@/assets/images/ellen-white-portrait.png");

interface EllenWhitePortraitProps {
  size?: number;
  isSpeaking?: boolean;
  onPress?: () => void;
  testID?: string;
...
export default function EllenWhitePortrait({
  size = 56,
  isSpeaking = false,
  onPress,
  testID,
}: EllenWhitePortraitProps) {
