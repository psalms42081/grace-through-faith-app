...
- **Role System:** Supports "member," "student," "church_leader," "editor," and "admin" roles with role-gated middleware. Pipeline read access available to church_leader, editor, and admin. Write/approve actions restricted to editor and admin.
