...
- **4D Scripture Context Panel:** Floating compass button in the chapter reader that expands to show AI-generated contextual data for the current chapter — locations, timeline events, key figures, and cultural insights. Tabbed interface (Places, Timeline, Figures, Culture). Data cached in `chapter_context_cache` table. API: `GET /api/chapter-context/:bookId/:chapter`. Generates + caches on first view.
