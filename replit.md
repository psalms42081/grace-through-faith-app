...
- **Shared UI Components:** Reusable `SectionHeader` (`components/SectionHeader.tsx`) and `AnimatedSection` (`components/AnimatedSection.tsx`) extracted from duplicated patterns. Used across Home, Connect, Kids Stars, and other screens.
