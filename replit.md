...
- **Study Screen Architecture:** Finalized Study tab with "Study Scripture" hero section containing three inline study mode cards (Quick Read → reader, Guided Study → AI Socratic tutor at `/study-guide`, Deep Study → 4-Layer study with state-aware subtitle showing resume/progress). Below the hero: "Continue Your Journey" (active 4-layer progress + enrolled paths), then demoted secondary sections — "Learning Paths" (Study Paths, 28 Beliefs Deep Dive, Devotional Plans, Study Resources), "Prophecy & End Times" (Prophecy Explorer, Great Controversy Timeline), "Reference" (Historic Voices, Fundamental Beliefs Library, Bible Maps & Timeline), and bottom browse sections (Beloved Passages, Spiritual Themes). Clear product differentiation: Fundamental Beliefs Library = browse/reference; 28 Beliefs Deep Dive = guided learning path.
