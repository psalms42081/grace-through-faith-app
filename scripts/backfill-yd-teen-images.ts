...
const TEEN_IDENTITY_SCENES: SceneData[] = [
  { sceneIndex: 0, narration: "In a softly lit room, you stare into the mirror, feeling a rush of doubt trickling in like cold water. Who am I? The question echoes. Social media tells you one thing. Friends say another. The world seems to have a hundred definitions for who you should be.", illustrationPrompt: "Teen alone at school, scrolling phone", imageUrl: "/assets/kids-scenes/teen-identity-scene-0.png", mood: "TENSION" },
  { sceneIndex: 1, narration: "Suddenly, a warm voice interrupts those thoughts, reminding you of a beautiful truth: you were knit together in your mother's womb. Psalm 139 says God knew you before you were born, that you are 'fearfully and wonderfully made.' Not an accident. Not a mistake. Designed with intention.", illustrationPrompt: "Teen looking at mirror, warm glow", imageUrl: "/assets/kids-scenes/teen-identity-scene-1.png", mood: "PEACE" },
  { sceneIndex: 2, narration: "Think of Jeremiah, the prophet who felt too young and unworthy. The words echo across the centuries: 'Before I formed you in the womb I knew you; before you were born I set you apart.' If God called Jeremiah despite his doubts, maybe He sees something in you too.", illustrationPrompt: "Young Jeremiah called in Jerusalem", imageUrl: "/assets/kids-scenes/teen-identity-scene-2.png", mood: "AWE" },
  { sceneIndex: 3, narration: "As more truth floods in about who you are in Christ, something shifts. You are chosen, loved, and accepted. Not because of what you do, but because of whose you are. The labels the world gives fade. What remains is the truth: 'You are a child of God.'", illustrationPrompt: "Teen walking confidently through hallway", imageUrl: "/assets/kids-scenes/teen-identity-scene-3.png", mood: "JOY" },
  { sceneIndex: 4, narration: "Each day brings challenges and moments of doubt, but you remember what God has declared over you. In Christ, you are a new creation. The old has gone, the new has come. Identity is not earned — it is received from the One who made you.", illustrationPrompt: "Teen at crossroads, choosing light", imageUrl: "/assets/kids-scenes/teen-identity-scene-4.png", mood: "PEACE" },
  { sceneIndex: 5, narration: "Stepping outside, you feel rejuvenated and ready to embrace who you are in Christ. The mirror no longer defines you. The opinions of others no longer control you. You walk in the freedom of knowing exactly whose you are.", illustrationPrompt: "Teen stepping into warm sunlight", imageUrl: "/assets/kids-scenes/teen-identity-scene-5.png", mood: "JOY" },
];
