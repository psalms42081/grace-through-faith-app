export const BIBLE_PROJECT_YOUTUBE_IDS: Record<string, string> = {
...
export interface ProphecyTeachingVideo {
  id: string;
  title: string;
  teacher: string;
  duration: string;
...
export const PROPHECY_TEACHING_VIDEOS = {
  daniel2: [{
    id: "4V0p5R7Ga8I",
...
export const DISCOVER_FEATURED_SERIES = {
...
export interface DiscoverWatchRailVideo {
  id: string;
  title: string;
  source: string;
  minutes: number;
