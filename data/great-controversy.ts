...
export const GC_NODES: GCNode[] = [
  ...
  },
  {
    ...
    significance: "The earthly sanctuary is central to understanding the Great Controversy. It reveals how God deals with sin: through substitution, mediation, and judgment. The Day of Atonement (Leviticus 16) is a type of the final judgment. The sanctuary is the key that unlocks Bible prophecy and the plan of salvation.",
  ...
  },
  {
    ...
    significance: "The Reformation is not a single event but a progressive recovery of truth that continues through the Advent movement. Each reformer rediscovered part of what was lost during the apostasy. The principle of 'present truth' \u2014 that God reveals truth progressively \u2014 is central to understanding our mission today.",
  ...
  },
  {
    ...
    significance: "1844 is a pivotal date in prophetic history. The 2,300-day prophecy of Daniel 8:14, beginning in 457 BC, reaches its fulfillment. The investigative judgment begins in heaven. This discovery launched the Advent movement and revealed the sanctuary truth that defines our understanding of Christ's ministry today.",
