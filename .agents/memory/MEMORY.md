...
- [Publish schema ownership](gtf-publish-schema-ownership.md) — Publish schema diff exclusively owns production DDL; builds are schema-neutral, while dev keeps its normal schema push.
