...
- [Adventech audio target duplicates](sabbath-school-audio-targets.md) — prefer Adult Bible Study Guide tracks; never use feed order or clear good URLs when audio metadata is partial.
...
- [Pastoral crisis authorship](gtf-pastoral-crisis-authorship.md) — agent builds region-aware resource plumbing; the human pastoral owner authors and approves all guidance.
