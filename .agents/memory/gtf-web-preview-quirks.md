...
## React Compiler can break guarded nullable API data
React Compiler hoisted nullable property reads (`lesson.days`, then `lesson.lessonNumber`) ahead of the Sabbath School loading guard, causing crashes that did not exist in source.
