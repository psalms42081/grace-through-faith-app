...
const MUSIC_CATEGORIES: MusicCategory[] = [
  ...
  {
    title: "3ABN Music & Worship",
    icon: "tv",
    gradient: ["#2E7D32", "#1B5E20"],
    description: "Music programming from Three Angels Broadcasting Network",
    items: [
      { title: "3ABN Praise Him Music", artist: "3ABN", description: "Live worship and praise music specials", url: "https://www.youtube.com/results?search_query=3ABN+Praise+Him+Music" },
      { title: "3ABN Hymns & Favorites", artist: "3ABN", description: "Classic hymns performed on 3ABN", url: "https://www.youtube.com/results?search_query=3ABN+hymns+worship" },
      { title: "Pillars of Faith Concert", artist: "3ABN", description: "Concert specials featuring faith-filled music", url: "https://www.youtube.com/results?search_query=3ABN+concert+special+music" },
      { title: "3ABN Kids Worship Songs", artist: "3ABN Kids", description: "Worship songs from 3ABN Kids Network", url: "https://www.youtube.com/results?search_query=3ABN+kids+worship+songs" },
    ],
  },
  {
    title: "For Kids",
