...
const styles = StyleSheet.create({
  ...
  introText: { fontSize: 14, lineHeight: 22, marginBottom: 8, opacity: 0.85 },
  card: {
    borderRadius: 18,
    borderWidth: 1,
    padding: 20,
  ...
  cardTitle: { fontSize: 16, letterSpacing: 0.1 },
  cardSubtitle: { fontSize: 10.5, textTransform: "uppercase", letterSpacing: 0.8 },
