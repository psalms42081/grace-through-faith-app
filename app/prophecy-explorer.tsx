...
const TIMELINE_MARKERS = [
  { year: "605 BC", label: "Babylon", color: "#D4A245", sectionId: "daniel2", symbolId: "d2-head" },
  { year: "539 BC", label: "Medo-Persia", color: "#A0A0B0", sectionId: "daniel2", symbolId: "d2-chest" },
  { year: "331 BC", label: "Greece", color: "#CD7F32", sectionId: "daniel2", symbolId: "d2-thighs" },
  { year: "168 BC", label: "Rome", color: "#6B6B6B", sectionId: "daniel2", symbolId: "d2-legs" },
  { year: "AD 476", label: "Divided", color: "#8B7355", sectionId: "daniel2", symbolId: "d2-feet" },
  { year: "AD 1798", label: "End of 1260", color: "#9333EA", sectionId: "daniel7", symbolId: "d7-horn" },
  { year: "AD 1844", label: "Judgment", color: "#C9933A", sectionId: "daniel89", symbolId: "d89-2300" },
  { year: "Future", label: "God's Kingdom", color: "#22C55E", sectionId: "revelation", symbolId: "rev-secondcoming" },
];

function TimelineBar({ theme, onMarkerPress }: { theme: any; onMarkerPress: (sectionId: string, symbolId: string) => void }) {
  return (
      ...
      <View style={tbStyles.markers}>
        {TIMELINE_MARKERS.map((marker) => (
          <Pressable
            ...
            onPress={() => onMarkerPress(marker.sectionId, marker.symbolId)}
            hitSlop={6}
          >
